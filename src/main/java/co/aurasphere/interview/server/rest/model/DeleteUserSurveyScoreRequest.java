...
/**
 * Request for
 * {@link UserRestController#deleteUserSurveyScore(DeleteUserSurveyScoreRequest)}.
 * 
 * @author Donato Rimenti
 */
public class DeleteUserSurveyScoreRequest implements Serializable {
	...
	/**
	 * The email of the user whose survey needs to be deleted.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeleteUserSurveyScoreRequest other = (DeleteUserSurveyScoreRequest) obj;
		if (email == null) {
			if (other.email != null)
				return false;
	...
	public String toString() {
		return "DeleteUserSurveyScoreRequest [email=" + email + ", surveyName=" + surveyName + ", surveyTime="
				+ surveyTime + "]";
	}
