...
public class User implements UserDetails {
	...
	/**
	 * The scores of the user in the surveys it took.
	 */
	...
	public String toString() {
		return "User [name=" + name + ", surname=" + surname + ", birthday=" + birthday + ", email=" + email
				+ ", authorities=" + authorities + ", password=" + password + ", scores=" + scores + ", creationTime="
				+ creationTime + ", updateTime=" + updateTime + ", technology=" + technology + ", enabled=" + enabled
				+ "]";
	}
